...
PACKAGES_CONF_FILE="pure-arch-packages.conf"
PACKAGES_LOG_FILE="pure-arch-packages.log"
COMMONS_CONF_FILE="pure-arch-commons.conf"
...
function aur_command_install() {
    ...
    local USER_NAME="$1"
    local COMMAND="$2"
    execute_aur "rm -rf /home/$USER_NAME/.pure-arch && mkdir -p /home/$USER_NAME/.pure-arch/aur && cd /home/$USER_NAME/.pure-arch/aur && git clone https://aur.archlinux.org/${COMMAND}.git && (cd $COMMAND && makepkg -si --noconfirm) && rm -rf /home/$USER_NAME/.pure-arch"
}
